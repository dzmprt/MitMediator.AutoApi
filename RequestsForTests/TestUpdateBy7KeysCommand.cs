...
[UpdateByKey("PUT", "v1", $"Just {nameof(TestUpdateBy7KeysCommand)} test")]
public class TestUpdateBy7KeysCommand : IRequest<string>, IKeyRequest<int, int, int, int, int, int, int>
{
