...
using SmokeTestWebApi.UseCase.Files.Commands.ImportFileBytes;
using SmokeTestWebApi.UseCase.Files.Commands.ImportFileBytesWithName;
using SmokeTestWebApi.UseCase.Files.Commands.ImportFileStream;
using SmokeTestWebApi.UseCase.Files.Commands.ImportFileStreamWithName;
...
using SmokeTestWebApi.UseCase.Test.Queries.GetWithQueryParams;
...
importFileBytesWithNameCommand.SetFile(stream, "img.png");
...
importFileBytesCommand.SetFile(stream, "img.png");
