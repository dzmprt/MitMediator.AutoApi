using LiteTestWebApi.UseCase.Test.Commands.PostBy6Keys;
using MitMediator;
using MitMediator.AutoApi.Abstractions;

namespace LiteTestWebApi.UseCase.Test.Commands.PostBy7Keys;

[PostByKey("POST", "v1", $"Just {nameof(TestPostBy6KeysCommand)} test")]
public class TestPostBy7KeysCommand : IRequest<string>, IKeyRequest<int, int, int, int, int, int, int>
{
