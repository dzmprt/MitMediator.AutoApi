...
[CreateByKey("CREATE", "v1", $"Just {nameof(TestCreateBy6KeysCommand)} test")]
public class TestCreateBy6KeysCommand : IRequest<string>, IKeyRequest<int, int, int, int, int, int>
{
