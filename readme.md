...
dotnet add package MitMediator.AutoApi -v 9.0.0-alfa-2

# for application layer
dotnet add package MitMediator.AutoApi.Abstractions -v 9.0.0-alfa-2

# for client application (MAUI, Blazor, UWP, etc.)
dotnet add package MitMediator.AutoApi.HttpMediator -v 9.0.0-alfa-2
```
