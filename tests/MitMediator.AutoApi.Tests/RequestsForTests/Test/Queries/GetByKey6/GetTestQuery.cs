...
namespace MitMediator.AutoApi.Tests.RequestsForTests.Test.Queries.GetByKey6;

[ExcludeFromCodeCoverage]
public class GetTestQuery : IRequest<string>, IKeyRequest<int, int, int, int, int, int>
{
