...
namespace MitMediator.AutoApi.Tests.RequestsForTests.Test.Commands.UpdateBy7Keys;

[ExcludeFromCodeCoverage]
public class UpdateTestBy7KeysCommand : IRequest<string>, IKeyRequest<int, int, int, int, int, int, int>
{
